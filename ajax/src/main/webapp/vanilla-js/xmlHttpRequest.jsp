...
<body>
	...
	document.searchFrm.addEventListener('submit', (e) => {
		e.preventDefault(); // 제출금지. 폼 제출 동기요청
		
		// 1. XMLHttpRequest 객체 생성
		xhr = new XMLHttpRequest();
		console.log(xhr);
		
		// 2. xhr 객체 연결상태 변화에 따른 핸들러함수 바인딩
	...
	const readyStateChangeHandler = (e) => {
		...
		case 0 : console.log('0 : uninitialized'); break; // xhr 객체 생성
		case 1 : console.log('1 : loading'); break; 	  // open 연결중
		case 2 : console.log('2 : loaded'); break;		  // send 요청
		case 3 : console.log('3 : interactive'); break;	  // 응답메시지 수신시작
		case 4 : console.log('4 : completed'); break;	  // 응답메시지 수신완료
		}
	...
	document.signupFrm.addEventListener('submit', (e) => {
		...
		// 2. readyStateChange  Handler 바인딩
		...
		// 4. send 요청 - 사용자 입력값 전달 (message body에 작성)
